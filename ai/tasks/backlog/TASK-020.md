# TASK-020: Column auto-sizing model

**Phase:** 3 — Core features
**Blocked by:** TASK-016 (core function needs TASK-014 column widths; React hook needs TASK-016 grid container for DOM measurement)
