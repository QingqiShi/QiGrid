/**
 * Sample employee data for the QiGrid playground.
 * Generates 100 rows of realistic-looking employee records.
 */
...
const firstNames = [
  ...
  "Ivan", "Julia", "Kevin", "Laura", "Michael", "Nora", "Oscar", "Patricia",
  "Quentin", "Rachel", "Steven", "Teresa", "Ulrich", "Vanessa", "William",
  "Xena", "Yusuf", "Zara", "Adrian", "Beatrice", "Carlos", "Delilah",
  "Ethan", "Francesca", "Gabriel", "Helena", "Isaac", "Jasmine", "Kyle",
  "Lydia", "Nathan", "Olivia", "Peter", "Quinn", "Rosa", "Samuel",
  "Tanya", "Uma", "Victor", "Wendy", "Xavier", "Yvonne",
] as const;

const lastNames = [
  "Anderson", "Brown", "Chen", "Davis", "Evans", "Fisher", "Garcia",
  "Hernandez", "Ibrahim", "Johnson", "Kim", "Lee", "Martinez", "Nguyen",
  "O'Brien", "Patel", "Quinn", "Robinson", "Smith", "Torres", "Ueda",
  "Vasquez", "Williams", "Xu", "Yang", "Zhang", "Baker", "Clark",
  "Diaz", "Foster", "Green", "Harris", "Ivanov", "Jones", "Khan",
  "Lopez", "Miller", "Nelson", "Ortiz", "Parker", "Reed", "Scott",
  "Taylor", "Underwood", "Vega", "Walker", "Xie", "Young", "Zimmerman",
  "Adams",
] as const;

const departments = [
  "Engineering", "Product", "Design", "Marketing", "Sales",
  "Finance", "Human Resources", "Operations", "Legal", "Customer Support",
] as const;
...
const jobTitles: Record<(typeof departments)[number], string[]> = {
  ...
  "Product": ["Product Manager", "Senior Product Manager", "Product Analyst", "Director of Product", "Associate PM"],
  ...
  "Human Resources": ["HR Manager", "Recruiter", "People Partner", "Compensation Analyst", "HR Coordinator"],
  "Operations": ["Operations Manager", "Supply Chain Analyst", "Logistics Coordinator", "COO", "Operations Analyst"],
  "Legal": ["Legal Counsel", "Paralegal", "Compliance Officer", "General Counsel", "Contract Manager"],
  "Customer Support": ["Support Engineer", "Support Lead", "CS Manager", "Technical Support", "Support Specialist"],
};

const locations = [
  "New York, NY", "San Francisco, CA", "Austin, TX", "Seattle, WA",
  "Chicago, IL", "Denver, CO", "Boston, MA", "Los Angeles, CA",
  "Portland, OR", "Atlanta, GA", "Miami, FL", "Remote",
] as const;
...
export function generateEmployees(count: number): Employee[] {
  ...
  for (let i = 0; i < count; i++) {
    ...
    // Salary range based on department with some randomness
    const baseSalary = department === "Engineering" ? 110000
      : department === "Product" ? 105000
      : department === "Sales" ? 90000
      : department === "Finance" ? 95000
      : department === "Legal" ? 100000
      : 85000;
